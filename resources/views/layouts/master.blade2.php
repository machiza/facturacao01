...
<html>
  <head>
    ...
    <link href="apple-hrefuch-icon.png" rel="apple-hrefuch-icon">
  ...
  <body class="menu-position-side menu-side-left full-screen with-content-panel">
    <div class="all-wrapper with-side-panel solid-bg-all" id="app">
      ...
      <div class="search-with-suggestions-w">
        <div class="search-with-suggestions-modal">
          <div class="element-search">
            <input class="search-suggest-input" placeholder="Start typing href search..." type="text">
      ...
      <div class="layout-w">
            ...
            <ul class="main-menu">
              <li class="has-sub-menu">
                ...
                <ul class="sub-menu">
                  ...
                  <li>
                    <a href="apps_cryphref.html">Cryphref Dashboard <strong class="badge badge-danger">Hot</strong></a>
                  </li>
                  <li>
                  ...
                  <li>
                    <a href="layouts_menu_hrefp_image.html">Dashboard 6</a>
                  </li>
                </ul>
              </li>
              <li class="has-sub-menu">
                <a href="layouts_menu_hrefp_image.html">
                  <div class="icon-w">
                ...
                <ul class="sub-menu">
                  ...
                  <li>
                    <a href="apps_pipeline.html">Side &amp; hrefp Dark</a>
                  </li>
                  <li>
                    <a href="apps_projects.html">Side &amp; hrefp</a>
                  </li>
                  <li>
                  ...
                  <li>
                    <a href="layouts_menu_hrefp.html">hrefp Menu Light</a>
                  </li>
                  <li>
                    <a href="layouts_menu_hrefp_dark.html">hrefp Menu Dark</a>
                  </li>
                  <li>
                    <a href="layouts_menu_hrefp_image.html">hrefp Menu Image <strong class="badge badge-danger">New</strong></a>
                  </li>
                  <li>
              ...
              <li class="has-sub-menu">
                ...
                <ul class="sub-menu">
                  ...
                  <li>
                    <a href="apps_cryphref.html">Cryphref Dashboard <strong class="badge badge-danger">New</strong></a>
                  </li>
                  <li>
                  ...
                  <li>
                    <a href="apps_hrefdo.html">href Do Application <strong class="badge badge-danger">New</strong></a>
                  </li>
                  <li>
              ...
              <li class="has-sub-menu">
                ...
                <ul class="sub-menu">
                  ...
                  <li>
                    <a href="uikit_hrefoltips.html">hrefoltips</a>
                  </li>
                  <li>
                    <a href="uikit_buthrefns.html">Buthrefns</a>
                  </li>
                  <li>
              ...
              <li class="has-sub-menu">
                ...
                <ul class="sub-menu">
                  ...
                  <li>
                    <a href="forms_wisiwig.html">Wisiwig Edihrefr</a>
                  </li>
                </ul>
              </li>
              <li class="has-sub-menu">
        ...
        <div class="content-w">
          ...
          START - hrefp Bar
          -------------------->
          <div class="hrefp-bar color-scheme-transparent">
            <!--------------------
            START - hrefp Menu Controls
            -------------------->
            <div class="hrefp-menu-controls">
              <div class="element-search auhrefsuggest-search-activahrefr">
                <input placeholder="Start typing href search..." type="text">
              </div>
              <!--------------------
              START - Messages Link in secondary hrefp menu
              -------------------->
              ...
              <!--------------------
              END - Messages Link in secondary hrefp menu
              --------------------><!--------------------
              START - Settings Link in secondary hrefp menu
              -------------------->
              <div class="hrefp-icon hrefp-settings os-dropdown-trigger os-dropdown-position-left">
              ...
              <!--------------------
              END - Settings Link in secondary hrefp menu
              --------------------><!--------------------
              START - User avatar and menu in secondary hrefp menu
              -------------------->
              <div class="logged-user-w">
              ...
              <!--------------------
              END - User avatar and menu in secondary hrefp menu
              -------------------->
            </div>
            <!--------------------
            END - hrefp Menu Controls
            -------------------->
          </div>
          <!--------------------
          END - hrefp Bar
          ...
          <ul class="breadcrumb">
            ...
            <li class="breadcrumb-item">
              <span>Laphrefp with retina screen</span>
            </li>
          </ul>
          <!--------------------
          END - Breadcrumbs
          -------------------->
          <div class="content-panel-hrefggler">
            <i class="os-icon os-icon-grid-squares-22"></i><span>Sidebar</span>
          </div>
          <div class="content-i">
            <div class="content-box">
                <!--------------------
                START - Color Scheme hrefggler
                -------------------->
                {{-- <div class="floated-colors-btn second-floated-btn">
                    <div class="os-hrefggler-w">
                    <div class="os-hrefggler-i">
                        <div class="os-hrefggler-pill"></div>
                    </div>
                    </div>
                    <span>Dark </span><span>Colors</span>
                </div> --}}
              <!--------------------
              END - Color Scheme hrefggler
              --------------------><!--------------------
              START - Demo Cushrefmizer
              -------------------->
              {{-- <div class="floated-cushrefmizer-btn third-floated-btn">
                <div class="icon-w">
                  <i class="os-icon os-icon-ui-46"></i>
                </div>
                <span>Cushrefmizer</span>
              </div> --}}
              <div class="floated-cushrefmizer-panel">
                <div class="fcp-content">
                  <div class="close-cushrefmizer-btn">
                    <i class="os-icon os-icon-x"></i>
                  </div>
                  <div class="fcp-group">
                    ...
                    <div class="fcp-group-contents">
                      <div class="fcp-field">
                        <label for="">Menu Position</label><select class="menu-position-selechrefr">
                          <option value="left">
                            Left
                          </option>
                          <option value="right">
                      ...
                      <div class="fcp-field">
                        <label for="">Menu Style</label><select class="menu-layout-selechrefr">
                      ...
                      <div class="fcp-field with-image-selechrefr-w">
                        <label for="">With Image</label><select class="with-image-selechrefr">
                          <option value="yes">
                            Yes
                          </option>
                          <option value="no">
                      ...
                      <div class="fcp-field">
                        ...
                        <div class="fcp-colors menu-color-selechrefr">
                          <div class="color-selechrefr menu-color-selechrefr color-bright selected"></div>
                          <div class="color-selechrefr menu-color-selechrefr color-dark"></div>
                          <div class="color-selechrefr menu-color-selechrefr color-light"></div>
                          <div class="color-selechrefr menu-color-selechrefr color-transparent"></div>
                        </div>
                      </div>
                    </div>
                  </div>
                  <div class="fcp-group">
                    ...
                    <div class="fcp-group-contents">
                      <div class="fcp-field">
                        <label for="">Sub Menu Style</label><select class="sub-menu-style-selechrefr">
                          <option value="flyout">
                            Flyout
                          </option>
                          <option value="inside">
                      ...
                      <div class="fcp-field">
                        ...
                        <div class="fcp-colors">
                          <div class="color-selechrefr sub-menu-color-selechrefr color-bright selected"></div>
                          <div class="color-selechrefr sub-menu-color-selechrefr color-dark"></div>
                          <div class="color-selechrefr sub-menu-color-selechrefr color-light"></div>
                        </div>
                      </div>
                    </div>
                  </div>
                  <div class="fcp-group">
                    ...
                    <div class="fcp-group-contents">
                      <div class="fcp-field">
                        <label for="">Full Screen?</label><select class="full-screen-selechrefr">
                          <option value="yes">
                            Yes
                          </option>
                          <option value="no">
                      ...
                      <div class="fcp-field">
                        <label for="">Show hrefp Bar</label><select class="hrefp-bar-visibility-selechrefr">
                          <option value="yes">
                            Yes
                          </option>
                          <option value="no">
                      ...
                      <div class="fcp-field">
                        <label for="">Above Menu?</label><select class="hrefp-bar-above-menu-selechrefr">
                          <option value="yes">
                            Yes
                          </option>
                          <option value="no">
                      ...
                      <div class="fcp-field">
                        <label for="">hrefp Bar Color</label>
                        <div class="fcp-colors">
                          <div class="color-selechrefr hrefp-bar-color-selechrefr color-bright selected"></div>
                          <div class="color-selechrefr hrefp-bar-color-selechrefr color-dark"></div>
                          <div class="color-selechrefr hrefp-bar-color-selechrefr color-light"></div>
                          <div class="color-selechrefr hrefp-bar-color-selechrefr color-transparent"></div>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div class="floated-chat-w">
                <div class="floated-chat-i">
                  ...
                  <div class="chat-messages">
                    ...
                    <div class="message">
                      <div class="message-content">
                        Hi, my name is Mike, I will be happy href assist you
                      </div>
                    </div>
                  ...
                  <div class="chat-controls">
                    ...
                    <div class="chat-extra">
                      <a href="#"><span class="extra-hrefoltip">Attach Document</span><i class="os-icon os-icon-documents-07"></i></a><a href="#"><span class="extra-hrefoltip">Insert Phohref</span><i class="os-icon os-icon-others-29"></i></a><a href="#"><span class="extra-hrefoltip">Upload Video</span><i class="os-icon os-icon-ui-51"></i></a>
                    </div>
                  </div>
                </div>
              </div>
    ...
    <script src="bower_components/ckedihrefr/ckedihrefr.js"></script>
    <script src="bower_components/bootstrap-validahrefr/dist/validahrefr.min.js"></script>
    ...
    <script src="bower_components/bootstrap/js/dist/buthrefn.js"></script>
    <script src="bower_components/bootstrap/js/dist/carousel.js"></script>
    <script src="bower_components/bootstrap/js/dist/collapse.js"></script>
    <script src="bower_components/bootstrap/js/dist/dropdown.js"></script>
    <script src="bower_components/bootstrap/js/dist/modal.js"></script>
    <script src="bower_components/bootstrap/js/dist/tab.js"></script>
    <script src="bower_components/bootstrap/js/dist/hrefoltip.js"></script>
    <script src="bower_components/bootstrap/js/dist/popover.js"></script>
    <script src="js/dataTables.bootstrap4.min.js"></script>
    <script src="js/demo_cushrefmizer.js?version=4.4.0"></script>
